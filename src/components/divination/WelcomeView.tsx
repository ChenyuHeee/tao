  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.text}>
        <p>
          《易经》作为中国古代哲学典籍，其核心价值在于对自然界与人类社会变化规律的朴素观察与辩证思考。阴阳互根、否极泰来、居安思危等观念，在认识论层面蕴含着深刻的思辨智慧。
        </p>
        <p>
          本工具基于《易经》六爻理论，以三枚铜钱摇掷六次，依阴阳变化推演卦象。这是一个帮助用户体验中国传统卦爻文化的自动化工具，所取者乃是对事物发展变化之情势与逻辑的分类参照，而非对超验力量的依附或宣扬。
        </p>
        <p>
