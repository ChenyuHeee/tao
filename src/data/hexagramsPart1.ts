...
const zhunHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(5, 0, '乘马班如，泣血涟如。', '骑在马上徘徊不前，哭得血泪涟涟。提示走到了极端困境，情绪过度低落却无济于事，需要调整心态。'),
    ] as [LineData, LineData, LineData, LineData, LineData, LineData],
  };
})();
...
const mengHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(3, 0, '困蒙，吝。', '困在蒙昧之中走不出来，需要多加注意。提示如果自己不求学、不向外求教，便会一直困在无知中。'),
...
const songHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(1, 1, '不克讼，归而逋，其邑人三百户，无眚。', '争讼未能取胜，回去躲避起来。在一个小地方安居，不会遇到麻烦。'),
...
const shiHex = (() => {
  ...
  return {
    ...
    lowerTrigram: lower,
    lines: [
      line(0, 0, '师出以律，否臧凶。', '军队出征必须有纪律约束，若纪律涣散则需要格外谨慎。'),
      line(1, 1, '在师中，吉无咎，王三锡命。', '身在军中指挥得当，吉利而不会有过失，君王再三褒奖委以重任。'),
      line(2, 0, '师或舆尸，凶。', '军队可能载着尸体回来，处境会比较艰难。提示用人不当可能导致较大的挫折。'),
...
const biHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(4, 1, '显比，王用三驱，失前禽。邑人不诫，吉。', '光明正大地亲附。君王打猎时网开一面，放走前面的猎物，百姓不会感到不安，这样是吉利的。'),
...
const xiaoChuHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(3, 0, '有孚，血去惕出，无咎。', '心怀诚信，远离伤害和担忧，不会有过失。'),
...
const lvHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(2, 0, '眇能视，跛能履，履虎尾，咥人，凶。武人为于大君。', '眼睛不好却偏要去看，脚不好却偏要去走。踩到虎尾而被咬伤，处境比较艰难。像武夫去充当君王一样不恰当。'),
...
const piHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(2, 0, '包羞。', '包藏羞耻。提示在逆境中可能需要接受不太理想的情况。'),
      line(3, 1, '有命无咎，畴离祉。', '顺应时运的安排，不会有过失。与同伴一起可以得到福祉。'),
      line(4, 1, '休否，大人吉。其亡其亡，系于苞桑。', '阻塞的局面即将结束，有德之人迎来吉利。但不可大意，要像把东西系在坚韧的桑枝上一样随时警惕，因为困难随时可能出现。'),
...
const yuHex = (() => {
  ...
  return {
    ...
    lowerTrigram: lower,
    lines: [
      line(0, 0, '鸣豫，凶。', '以安逸享乐而自鸣得意，情况不太有利。'),
...
const shiHeHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(5, 1, '何校灭耳，凶。', '肩上戴着枷锁遮住了耳朵，处境不利。提示惩罚到了极致而不知悔改。'),
    ] as [LineData, LineData, LineData, LineData, LineData, LineData],
  };
})();
...
const boHex = (() => {
  ...
  return {
    ...
    lowerTrigram: lower,
    lines: [
      line(0, 0, '剥床以足，蔑贞凶。', '从床脚开始剥落，动摇了根基，失去了正道则需要警惕。'),
      line(1, 0, '剥床以辨，蔑贞凶。', '剥落到了床的中间部分，进一步侵蚀了基础，失去正道更需要警惕。'),
      line(2, 0, '剥之，无咎。', '在剥落的过程中能保持清醒独立，不会有大的过失。'),
      line(3, 0, '剥床以肤，凶。', '剥落到了床面上，已经触及皮肤，情况比较严重。提示影响已经到了切身的地步。'),
...
const fuHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(5, 0, '迷复，凶，有灾眚。用行师，终有大败，以其国君凶，至于十年不克征。', '迷失了回归的路，处境不利，可能会遇到困难。此时若出兵，最终可能面临较大的挫折。因为连国君都迷失了方向，十年之内都难以恢复力量。'),
    ] as [LineData, LineData, LineData, LineData, LineData, LineData],
  };
})();
...
const wuWangHex = (() => {
  ...
  return {
    ...
    lines: [
      ...
      line(2, 0, '无妄之灾，或系之牛，行人之得，邑人之灾。', '无缘无故的麻烦。有人把牛系在那里，过路的人牵走了，村里的人反而被怀疑。提示有时候不顺利是完全没有道理的。'),
...
const yiHex = (() => {
  ...
  return {
    ...
    lowerTrigram: lower,
    lines: [
      line(0, 1, '舍尔灵龟，观我朵颐，凶。', '舍弃你自己的灵龟智慧，却来看我咀嚼食物，这是得不偿失的。提示不要舍本逐末。'),
